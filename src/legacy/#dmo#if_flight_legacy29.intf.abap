...
INTERFACE /dmo/if_flight_legacy29
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL29
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel29     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING29
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking29    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_29
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_29 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT29
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight29 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id29.
  ...
  TYPES booking_id TYPE /dmo/booking_id29.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id29.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL29, /DMO/BOOKING29, /DMO/BOOK_SUP_29 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code29.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code29,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status29,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel29_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id29.
  INCLUDE TYPE /dmo/booking29_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id29.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id29.
  INCLUDE TYPE /dmo/book_sup_29_data.
