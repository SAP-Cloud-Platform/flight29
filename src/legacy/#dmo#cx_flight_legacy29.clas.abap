CLASS /dmo/cx_flight_legacy29 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_29',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_29',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id29 OPTIONAL
        booking_id            TYPE /dmo/booking_id29 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id29 OPTIONAL
        agency_id             TYPE /dmo/agency_id29 OPTIONAL
        customer_id           TYPE /dmo/customer_id29 OPTIONAL
        carrier_id            TYPE /dmo/carrier29-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_29-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_29-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date29 OPTIONAL
        end_date              TYPE /dmo/end_date29 OPTIONAL
        booking_date          TYPE /dmo/booking_date29 OPTIONAL
        flight_date           TYPE /dmo/flight_date29 OPTIONAL
        status                TYPE /dmo/travel_status29 OPTIONAL
        currency_code         TYPE /dmo/currency_code29 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id29,
          mv_booking_id            TYPE /dmo/booking_id29,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id29,
          mv_agency_id             TYPE /dmo/agency_id29,
          mv_customer_id           TYPE /dmo/customer_id29,
          mv_carrier_id            TYPE /dmo/carrier29-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_29-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_29-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date29,
          mv_end_date              TYPE /dmo/end_date29,
          mv_booking_date          TYPE /dmo/booking_date29,
          mv_flight_date           TYPE /dmo/flight_date29,
          mv_status                TYPE /dmo/travel_status29,
          mv_currency_code         TYPE /dmo/currency_code29,
...
CLASS /dmo/cx_flight_legacy29 IMPLEMENTATION.
